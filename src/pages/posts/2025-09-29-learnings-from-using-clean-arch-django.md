...
![Fat models](../../../public/assets/img/fat_models.png)
...
class UserRepository:
    def get_user(self, user_id: int) -> User:
        ...
        return User(user.email, user.age, user.subscription_type)
...
class UserClassificationService:
    def classify_user(self, user: User) -> str:
...
![title](../../../public/assets/img/service_layer.png)
...
class User(models.Model):
    ...
    def classify_user(self):
        ...
        return ClassifyUserService(self.email, self.age, self.subscription_type).execute()
...
class ClassifyUserService:
    def __init__(self, user):
        ...
        self.user.subscription_type = user.subscription_type
